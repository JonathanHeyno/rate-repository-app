...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
      it('renders repository information correctly', () => {
        ...
        const checkRepositoryItem = (repositoryItem, texts) => {
            for (let text of texts) {
                expect(repositoryItem).toHaveTextContent(text);
              }
        }

        checkRepositoryItem(firstRepositoryItem, firstRepositoryData);
        checkRepositoryItem(secondRepositoryItem, secondRepositoryData);
      });
    });
});